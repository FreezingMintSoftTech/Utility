...
namespace LUtil
{
    ...
    internal class SpriteDrawUtility
    {
        ...
        private static void DrawSprite(Texture tex, Rect drawArea, Vector4 padding, Rect outer, Rect inner, Rect uv, Color color, Material mat)
        {
            ...
            // Draw the background
            UnityEditor.EditorGUI.DrawTextureTransparent(outerRect, null, ScaleMode.ScaleToFit, outer.width / outer.height);
            ...
            else
            {
                ...
                UnityEditor.EditorGUI.DrawPreviewTexture(paddedTexArea, tex, mat);
            }
